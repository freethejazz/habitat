...
import {fetchPackage, fetchProject} from "../actions/index";
...
export class PackagePageComponent implements OnInit {
    ...
    private fetchProject() {
        let projectId = `${this.package.ident.origin}/${this.package.ident.name}`;
        this.store.dispatch(fetchProject(projectId, this.token, false));
    }
